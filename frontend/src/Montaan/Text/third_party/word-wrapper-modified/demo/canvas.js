...
var lipsum =
	'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vestibulum luctus, elit nec rutrum interdum, ipsum nulla auctor magna, ut tincidunt turpis ex efficitur orci. Aenean maximus interdum diam, nec consequat sapien ullamcorper ac. In et tortor dictum, commodo enim ac, sodales dolor.';
...
var slides = [
	{
		text: lipsum,
		description: 'normal at 200px',
		width: 200,
		measure: metrics,
	},
	{
		text: multiline,
		description: 'nowrap (newline only)',
		mode: 'nowrap',
		measure: metrics,
	},
	{
	...
	{
		text: code,
		description: 'pre clipped to 200px',
		mode: 'pre',
		clip: true,
		width: 200,
		measure: metrics,
